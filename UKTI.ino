...
strip.setPixelColor(i, strip.Color(204 /20, 0/20, 0/20));
  strip.show();
}
...
strip.setPixelColor(i, strip.Color(204, 0, 0));
  strip.show();
}

//for (int i = ; i < 10; i++) { //back
//
//strip.setPixelColor(i, strip.Color(204, 0, 0));
//  strip.show();
//}
...
//  // Fill the entire strip with...
 // colorWipe(strip.Color(204,   0,   0), 1);  // Red
 // colorWipe(strip.Color(  0, 0,102), 1);  // blue
